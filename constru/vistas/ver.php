<?php 
	...
	if(isset($_POST['envio'])){
		$con = new Conexion();
		$sql1 = "SELECT * FROM const WHERE ubicacion = '{$_POST['estanteria']}' order by idcontrol";
		$sql2 = "SELECT distinct(ubicacion) FROM const WHERE ubicacion = '{$_POST['estanteria']}'";
	...
	<tbody>
		<?php while($row = mysql_fetch_array($resultado1)): ?>
			<tr>
				...
				<td ALIGN=center><a href="mostrar.php?id=<?php echo $row['id']; ?>">Ingresar</a></td>
			</tr>
		<?php endwhile; ?>
	</tbody>	
</table>
