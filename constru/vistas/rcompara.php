...
<?php 
    ...
    $con = new Conexion();
    $sql = "SELECT * FROM apape2 WHERE sta>0 and existencias!=fisico and conteo1 !=0 order by ubicacion,idcontrol,idalterno";
...
<html>
    ...
    <body>
        <header>
           REPUESTOS DIFERENCIAS INVENTARIO
        </header>
	...
	<tbody>
		<?php while($row = mysql_fetch_array($resultado)): ?>
			<tr>
				...
				<td ALIGN=center><?php echo number_format($row['existencias'],2,".",","); ?></td>
