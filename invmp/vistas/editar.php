...
<?php 
	...
	if(isset($_POST['envio']))
	{
		...
		{
			$sql2 = "UPDATE invfisico SET fisico='{$_POST['conteo1']}',conteo1='{$_POST['conteo1']}',sta=1 WHERE id ='{$_POST['id']}'";
		...
		else
		{
			...
			{
				$sql2 = "UPDATE invfisico SET fisico='{$_POST['conteo2']}',conteo2='{$_POST['conteo2']}',sta=2 WHERE id ='{$_POST['id']}'";
				$con->consultaSimple($sql2);
			...
			else
			{
				...
				{
				$sql2 = "UPDATE invfisico SET fisico='{$_POST['conteo3']}',conteo3='{$_POST['conteo3']}',sta=3 WHERE id ='{$_POST['id']}'";
				$con->consultaSimple($sql2);
				...
				else
				{
					...
					{
					$sql2 = "UPDATE invfisico SET fisico='{$_POST['conteo4']}',conteo4='{$_POST['conteo4']}', sta=4 WHERE id ='{$_POST['id']}'";
					$con->consultaSimple($sql2);
					...
					else
					{
						...
						{
						$sql2 = "UPDATE invfisico SET fisico='{$_POST['conteo5']}',conteo5='{$_POST['conteo5']}', sta=5 WHERE id ='{$_POST['id']}'";
						$con->consultaSimple($sql2);
