...
$sql=mysqli_query($con,"insert into operadors(specilization,operadorName,address,docFees,contactno,docEmail,password) values('$docspecialization','$docname','$docaddress','$docfees','$doccontactno','$docemail','$password')");
if($sql)
{
echo "<script>alert('El Operador ha sido registrado con exito!');</script>";
echo "<script>window.location.href ='manage-operadors.php'</script>";
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"> | Agregar Operador</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Información del Operario a ingresar</h5>
												</div>
...
<input type="email" id="docemail" name="docemail" class="form-control"  placeholder="correo @papelera.com" required="true" onBlur="checkemailAvailability()">
