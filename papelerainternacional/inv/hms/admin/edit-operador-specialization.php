...
$id=intval($_GET['id']);
	$sql=mysqli_query($con,"select * from operadorSpecilization where id='$id'");
while($row=mysqli_fetch_array($sql))
{														
	?>		<input type="text" name="operadorspecilization" class="form-control" value="<?php echo $row['specilization'];?>" >
	<?php } ?>
														</div>
